...
<Callout emoji='💡'>
  Functional components are now preferred over class components due to the
...
<Callout emoji='🔑'>
  Understanding components, JSX, props, and state is crucial for building React
  applications. These concepts form the foundation of your React journey.
</Callout>
